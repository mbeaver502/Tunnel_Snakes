 ...
 *                          find the user manual folder or the index.html file to open online help.
 *                       
 *************************************************************************************************/
...
namespace Assist_UNA
{
    public partial class MainForm : Form
    {
        ...
        const int MAINFORM_MIN_HEIGHT = 625;
        ...
        private void MenuHelpOnlineClick(object sender, EventArgs e)
        {
            try
            {
                ...
                while (HelpPath.Length > 5 && !HelpPath.EndsWith("index.html"))
                {
                    if (File.Exists(HelpPath + "\\index.html"))
                        HelpPath += "\\index.html";
            ...
            {
                MessageBox.Show("Online Manual index not found.", "Error");
            }
        }
        ...
        private void RemoveOverflow()
        {
            for (int i = 0; i < txtSource.Lines.Length - 1; i++)
            {
                ...
                {
                    txtSource.Select(txtSource.GetFirstCharIndexFromLine(i) + 79, txtSource.Lines[i].Length - 79);
                    txtSource.SelectedText = "";
                }
